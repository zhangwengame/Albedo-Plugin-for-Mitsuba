 ...
 * }
 */
class MIPathTracer_albedo : public MonteCarloIntegrator {
public:
	MIPathTracer_albedo(const Properties &props)
		: MonteCarloIntegrator(props) { }

	/// Unserialize from a binary data stream
	MIPathTracer_albedo(Stream *stream, InstanceManager *manager)
...
MTS_IMPLEMENT_CLASS_S(MIPathTracer_albedo, false, MonteCarloIntegrator)
MTS_EXPORT_PLUGIN(MIPathTracer_albedo, "MI path tracer");
MTS_NAMESPACE_END
